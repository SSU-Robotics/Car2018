...
#include "tc22xa/IfxStm_reg.h"
#include "tc22xa/IfxStm_bf.h"

#if defined(APPKIT_TC23XX) || defined(APPKIT_TC234TFT) || defined(APPKIT_TC237TFT)
...
#endif /* APPKIT_TC23XX || APPKIT_TC234TFT || APPKIT_TC237TFT */

#if (USE_DISABLE_EXT_WDT == 1)
# include "tc23xa/IfxPort_reg.h"
# include "tc23xa/IfxQspi_reg.h"
...
static void wait(unsigned int time)
{
	...
	unsigned int stmWaitCount = (fSTM / 100) * time / 10000;
